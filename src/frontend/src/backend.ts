...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint): Promise<void> {
    ...
    async initializeDefaultContactInfo(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeDefaultContactInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
